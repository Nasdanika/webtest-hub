...
public class GuestAppControllersRenderer {
  ...
  protected final String TEXT_1 = NL + "angular.module('guestApp', []).controller('registrationController', function($scope, $http) {" + NL + "\tconsole.log(\"Registration controller\");" + NL + "\t" + NL + "\t$scope.registrationData = {};" + NL + "\t" + NL + "\t$scope.errorData = {};" + NL + "" + NL + "\t$scope.register = function() {" + NL + "\t\t$http.post('";
  protected final String TEXT_2 = "/register', $scope.registrationData).success(function(data) {" + NL + "\t\t\tif (data.target) {" + NL + "           \t\twindow.location = data.target;" + NL + "           \t} else {" + NL + "\t\t\t\t$scope.errorData = data;       " + NL + "\t\t\t\tconsole.dir(data);    \t\t" + NL + "           \t}" + NL + "        }).error(function(data, status, headers, config) {" + NL + "\t\t\talert(\"Registration failed: \"+status);" + NL + "\t\t});" + NL + "\t};" + NL + "" + NL + "});" + NL + "" + NL + "angular.module('guestApp').controller('loginController', function($scope, $http) {" + NL + "\tconsole.log(\"Login controller\");" + NL + "" + NL + "\t// create a blank object to hold our form information" + NL + "\t// $scope will allow this to pass between controller and view" + NL + "\t$scope.loginData = {" + NL + "\t\t" + NL + "\t};" + NL + "" + NL + "\t// process the form" + NL + "\t$scope.login = function() {" + NL + "\t\t$http.post('";
